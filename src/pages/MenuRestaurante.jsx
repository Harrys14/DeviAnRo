...
function MenuRestaurante() {
  ...
  /* =========================================================
     CARGAR PRODUCTOS Y RESTAURANTE
  ========================================================= */
    ...
    const cargarDatos = async () => {
      ...
      try {
        ...
        /*
          ...
          Ya no usamos getRestauranteById(id).

          Los IDs como 42, 43, 45, etc. pueden no existir
          actualmente en /restaurantes/:id.

          Sin embargo, los productos sí están relacionados
          correctamente con esos IDs y getProductosPorRestaurante()
          está devolviendo los productos.

          Por eso obtenemos la información del restaurante
          directamente desde el primer producto relacionado.
        */

        const productosData = id
        ...
        /*
          Buscar el restaurante dentro de los productos.

          Cada producto normalizado puede tener:
        ...
        */
        ...
        const restauranteData =
          productoConRestaurante?.restaurante || null;

        console.log(
          "RESTAURANTE OBTENIDO DESDE PRODUCTO:",
          restauranteData
        );
  ...
  const filtrados = useMemo(() => {
    ...
    return productosConImagen.filter(
      (p) => {
          ...
          <>
            ...
            0 ? (
              ...
              <section className="menu-empty">
                ...
                <button
                  type="button"
                  className="btn-primary menu-empty-btn"
                  onClick={
                    limpiarFiltros
                  }
                >
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="menu-card-imgWrap">
                          ...
                          <div
                            className="menu-card-imgOverlay"
                            aria-hidden
                          />
